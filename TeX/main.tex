...
Um detalhe a ser observado é que $\beta(t)$ é nulo apenas se $\beta(0) = 0$, o que gera o equilíbrio $[N, 0, 0, 0, 0]$, mas que não é de nosso interesse, pois nesse caso não haveria epidemia. Assim, considerando $\beta(t) > 0$ temos, pelas duas últimas equações, que no equilíbrio $I = 0$.
...
Já se considerando que $\alpha(t) = 0$, poderemos ter, em algum momento da interação, algum equilíbrio da forma $[s, e, 0, r, N - s - e - r]$, o que representaria que a doença deixou de ser infecciosa.
